  ...
  return (
    <div>
      <PageHeader title="Movimentações de Estoque" breadcrumbs={['Início','Estoque','Movimentações']}
        actions={<button onClick={()=>setShowModal(true)} className="flex items-center gap-1.5 px-3 py-1.5 text-xs nomus-blue-bg text-white rounded hover:opacity-90"><Plus size={13}/> Nova Movimentação</button>}
      />
