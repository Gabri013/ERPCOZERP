...
const MENU_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: 'Serviços', icon: Briefcase, children: [
          { label: 'Solicitações de Cotação', path: '/servicos/solicitacoes',  required: 'ver_pedidos' },
          { label: 'Propostas Comerciais',    path: '/servicos/propostas',     required: 'ver_pedidos' },
          { label: 'Pedidos de Serviço',      path: '/servicos/pedidos',       required: 'ver_pedidos' },
          { label: 'Emissão de NFS-e',        path: '/servicos/nfse',          required: 'ver_pedidos' },
          { label: 'Serviços Recorrentes',    path: '/servicos/recorrentes',   required: 'ver_pedidos' },
          { label: 'Tabela de Preços',        path: '/servicos/tabela-precos', required: 'ver_pedidos' },
        ],
      },
      {
    ...
    items: [
      { label: 'Relatórios', icon: BarChart2, path: '/relatorios', required: 'relatorios:view' },
      {
        label: 'Configurações', icon: Settings, children: [
          ...
          { label: 'Fluxo do Pedido', path: '/configuracoes/fluxo-pedido', alwaysShow: true },
        ],
      },
    ],
  },
