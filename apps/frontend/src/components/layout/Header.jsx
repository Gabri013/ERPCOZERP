...
const BREADCRUMB_MAP = {
  ...
  '/producao/custeio-real':   ['Produção', 'Custeio Real'],
  '/contabilidade':                  ['Contabilidade', 'Contabilidade'],
  '/contabilidade/integracao':       ['Contabilidade', 'Integração Contábil e Fiscal'],
  '/qualidade':                      ['Qualidade', 'Controle de Qualidade'],
  '/qualidade/documentos':           ['Qualidade', 'Gestão de Documentos'],
  '/qualidade/databooks':            ['Qualidade', 'Databooks'],
  '/expedicao':                      ['Expedição', 'Controle da Expedição'],
  '/projetos':                       ['Projetos', 'Gestão de Projetos'],
  '/crm':                            ['CRM', 'Gestão de Processos'],
  '/conhecimento':                   ['Conhecimento', 'Base de Conhecimento'],
  '/sobre':                          ['Conhecimento', 'Como Funciona'],
