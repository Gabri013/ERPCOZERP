...
const SaleOrdersPage = lazy(() => import('@/pages/vendas/SaleOrdersPage'));
const QuotesPage = lazy(() => import('@/pages/vendas/QuotesPage'));
const PriceTablesPage = lazy(() => import('@/pages/vendas/PriceTablesPage'));
const SalesReportPage = lazy(() => import('@/pages/vendas/SalesReportPage'));
    ...
    <Suspense fallback={<RouteFallback />}>
      <Routes>
        <Route element={<ERPLayout />}>
          ...
          <Route path="/vendas/pedidos" element={<PermissaoRoute acao="ver_pedidos"><SaleOrdersPage /></PermissaoRoute>} />
          <Route path="/vendas/clientes" element={<PermissaoRoute acao="ver_clientes"><Clientes /></PermissaoRoute>} />
          <Route path="/vendas/orcamentos" element={<PermissaoRoute acao="ver_pedidos"><QuotesPage /></PermissaoRoute>} />
          <Route path="/vendas/tabela-precos" element={<PermissaoRoute acao="ver_pedidos"><PriceTablesPage /></PermissaoRoute>} />
          <Route path="/vendas/relatorios" element={<PermissaoRoute acao="relatorios:view"><SalesReportPage /></PermissaoRoute>} />
          <Route
